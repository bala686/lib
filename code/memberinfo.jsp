...
{   int c;
	...
	ResultSet  rs=st.executeQuery("select *from member where email='"+email+"'");
	while(rs.next()){
	%>
...
<abody>
<nav>  
<ul>   <li><a href="EditmemberForm?id=${userId}">Edit</a></li>
        <li><a href="memviewbook">View Book</a></li>
        <li><a href="IssueBookForm">Issue Book</a></li>
        <li><a href="memViewIssue?id=${userId}">View Issued Book</a></li>
