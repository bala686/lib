...
/**
 * Servlet implementation class memViewIssue
 */
@WebServlet("/memViewIssue")
public class memViewIssue extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int memberid=Integer.parseInt(sid);
		List<IssueBooks> list=BookDao.viewIssuedBook(memberid);
